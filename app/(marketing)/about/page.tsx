...
export const metadata: Metadata = {
  ...
  description:
    "agentplain is building a pre-trained AI agent fleet for professional-services firms. Realty first.",
};
      ...
      <section className="border-b border-rule bg-paper">
        <div className="container-wide py-20 md:py-28">
          ...
          <h1 className="max-w-3xl font-display text-5xl leading-[1.05] text-ink md:text-7xl md:leading-[1.02]">
            Quiet software for professional-services firms.
          </h1>
        </div>
      </section>
        ...
        <div className="container-wide grid gap-12 py-20 md:grid-cols-[1fr_2fr] md:py-28">
          ...
          <div className="max-w-prose space-y-6 text-lg leading-relaxed text-ink-soft">
            ...
            <p>
              ...
              is built around the opposite belief — what professional-services
              firms need is fewer tabs to keep open, fewer manual handoffs to
              remember, and fewer hours spent on operations that someone,
              somewhere, has already done a thousand times.
            </p>
            <p>
              The product is a fleet of pre-trained agents, scoped narrowly to
              the recurring jobs of running a professional-services firm.
              Realty is our first vertical. The fleet hands off to a human at
              the steps where a human still has to decide.
            </p>
      ...
      <section className="border-b border-rule bg-paper-deep">
        <div className="container-wide grid gap-12 py-20 md:grid-cols-[1fr_2fr] md:py-28">
          ...
          <div className="max-w-prose space-y-5 text-[15px] leading-relaxed text-ink-soft">
            ...
            <p>
              <span className="text-ink">Not a CRM.</span> The agents draft
              into the CRM you already pay for; your operator applies changes.
              We do not ask you to migrate.
            </p>
            <p>
