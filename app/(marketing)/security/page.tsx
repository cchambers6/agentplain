...
// label ("Security") already lives in the hero eyebrow, so each section heading
// is now a single, clear h2. Pass `eyebrow` only when a section genuinely wants
// a distinct category label above its title (none here). (Wave A3, 2026-06-11.)
function Section({
  title,
  eyebrow,
  label,
