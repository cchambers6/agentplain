/**
 * app/api/integrations/google-calendar-mcp/[workspaceId]/route.ts
 *
 * Workspace-scoped HTTP entry to the Google Calendar MCP server. Thin wrapper
...
} from '@/lib/integrations/google-calendar-mcp/tools';
import type { GoogleCalendarMcpServer } from '@/lib/integrations/google-calendar-mcp';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

const SPEC: McpRouteSpec<GoogleCalendarMcpServer> = {
  buildServer: buildGoogleCalendarMcpServer,
