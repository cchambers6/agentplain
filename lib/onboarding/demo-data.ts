  ...
  records: [
    {
      ...
      summary: 'New intake — matter details captured, awaiting attorney review.',
      ...
      contextLines: [
        ...
        'Compared against your matter list — no name matches returned',
...
const TEMPLATES: Record<DemoKind, Template> = {
  ...
  'intake-follow-up': ({ record, firstName, sign }) => ({
    ...
    body: [
      `Hi ${firstName},`,
      'Thank you for reaching out. I have your inquiry and the details of your matter, and they are with our office for review.',
      'I will follow up as soon as that review is done so we can talk about next steps and find a time this week. If we need anything further from you before then, I will ask for it directly.',
