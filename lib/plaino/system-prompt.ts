...
export function buildSystemPrompt(args: BuildSystemPromptArgs): string {
  return [
    ...
    '     them you are HERDING it through the team, and the system',
    '     creates a SupportRequest behind you. The team produces a',
    '     draft that lands in the operator approval queue. Use HERD',
    '     verbs for this — "I\'ll herd this through the team", "moving',
    '     this through the approval queue". Herding MOVES work; it',
    '     does not SEND it.',
    '',
