...
export const homeServices: VerticalContent = {
  ...
  roi: {
    ...
    citation:
      "Supplement-savings claim cited verbatim from `b2b_vertical_opportunity_analysis_2026-04-27.md` §3.3. Pricing per `project_stripe_both_surfaces.md` (Partner tier per 2026-05-15 ratification; per-seat ladder $299→$199 — priority email/chat support and a quarterly async check-in, NO reserved human hours per the 2026-06-14 trial-policy ratification). ROI band per `project_pricing_value_anchor.md`.",
    violationAvoidance:
