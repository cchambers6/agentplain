...
export const realEstate: VerticalContent = {
  ...
  dataNote:
    "Your CRM holds clients mid-transaction — their financials, their motivations, the details a competitor would love — and that stays in your CRM. Plaino reads what a lead or a listing needs in the moment, drafts the reply, and writes the triage decision back; he never copies your contact database onto a server we keep.",
