...
export const recruiting: VerticalContent = {
  ...
  roi: {
    ...
    citation:
      "Pricing per `project_stripe_both_surfaces.md` (Regular tier per the 2026-05-15 three-tier ratification — Regular is the default entry path; recruiting shops wanting priority email/chat support and a quarterly async check-in can step up to Partner ($299→$199/seat), and high-intensity exec-search engagements route to Max (quote-based)). ROI band per `project_pricing_value_anchor.md` (Regular-tier value $2,900–$10,600/mo per seat). Time-allocation estimates pending primary-research validation — flagged in capability inbox. Response-rate-lift claim is operator-modeled, not customer-attested.",
    violationAvoidance:
