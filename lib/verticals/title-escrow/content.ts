...
export const titleEscrow: VerticalContent = {
  ...
  verticalFaq: [
    ...
    },
    {
      ...
      a: `${FLAT} per month. One flat price — the same whether you are a solo operator or a multi-closer office, and the same across every vertical. Month-to-month, with a ${TRIAL_PERIOD_DAYS}-day free trial (card at signup) and a ${MONEY_BACK_GUARANTEE_DAYS}-day money-back guarantee on your first charge. You can cancel anytime.`,
    },
    {
  ...
  roi: {
    ...
    math:
      "Average closer handles 30–50 files/month. File-intake automation saves ~45 minutes/file. 40 files × 0.75 hours × $40/hr × 12 months = $14,400/yr per closer. Closing-prep automation saves another ~30 minutes/file = ~$9,600/yr — total ~$24k/yr (~$2,000/mo) per closer. Against the flat ${FLAT}/month ($1,188/yr) that is ~20x for a single closer. Because the price does not scale with headcount, a multi-closer office multiplies the return on an unchanged bill: four closers reclaiming ~$96k/yr against the same $1,188/yr runs past 80x.",
    citation:
      "Pricing per `lib/billing/facts.ts` (`MONTHLY_PRICE_USD_CENTS`) — ONE flat monthly price, the same for every customer and every vertical, whatever the headcount. Trial + money-back mechanics per the same module. ROI band per `project_pricing_value_anchor.md` (value $2,900–$10,600/mo). Time-per-file estimates pending primary-research validation (flagged in capability inbox). Closer compensation midpoint based on US BLS 2024 SOC 13-2072, loan officers and related; flagged as operator-modeled.",
    violationAvoidance:
