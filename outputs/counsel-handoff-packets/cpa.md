# Counsel-handoff packet — cpa

> **Status: DRAFT** — counsel reviewer: _not yet assigned_
> Generated by `scripts/render-counsel-handoff-packets.ts` from the corpus rule files under `lib/agents/sentinel/corpus/cpa/`.
...
## Candidate literal triggers — for counsel red-line (10)

### Circular 230 § 10.30 — candidate advertising/solicitation triggers (DRAFT)

- **Rule id:** `circular-230-solicitation-candidates`
...
| --- | --- | --- |
| 1 | `guaranteed refund` | advertising |
| 2 | `guaranteed irs approval` | advertising |
| 3 | `guaranteed audit protection` | advertising |
| 4 | `irs approved` | advertising |
| 5 | `irs endorsed` | advertising |
| 6 | `official irs approved` | advertising |
| 7 | `special access to the irs` | advertising |
| 8 | `inside connections at the irs` | advertising |
| 9 | `we can get you out of any audit` | advertising |
| 10 | `audit-proof` | advertising |

## Counsel references (6)

### Circular 230 § 10.29 — conflicting interests

- **Rule id:** `circular-230-conflicts-10-29`
...
### Circular 230 § 10.27 — fees (contingent-fee restriction)

- **Rule id:** `circular-230-fees-10-27`
...
- **Rule id:** `circular-230-diligence-10-22`
...
### AICPA Code — Confidential Client Information Rule

- **Rule id:** `aicpa-confidential-client-information`
...
### AICPA Code — Due Care Principle (Article V)

- **Rule id:** `aicpa-due-care-principle`
...
### Georgia State Board of Accountancy — licensure and discipline

- **Rule id:** `ga-board-accountancy`
