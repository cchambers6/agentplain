...
// tests/tsconfig.test.json, so the `<>` fragment below becomes
// `React.createElement(React.Fragment, ...)` and `React` has to be a VALUE in
// scope. Without this line the module throws
